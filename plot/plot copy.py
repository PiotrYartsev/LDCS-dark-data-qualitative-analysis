...
con = sl.connect('Lund_GRIDFTP_all_fixed_delete_all.db')
...
plt.plot(time_no_problem_ult_ult,position_regular_ult,".",label="Not a duplicate", markersize=6,color="blue")
plt.grid(linestyle='--',)
