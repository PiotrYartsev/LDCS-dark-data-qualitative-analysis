...
print('number_of_files_LUND_all_fixed_delete_all',number_of_files_LUND_all_fixed_delete_all)
print('number_of_files_LUND_GRIDFTP_all_fixed_delete_all',number_of_files_LUND_GRIDFTP_all_fixed_delete_all)

print('number_of_files_SLAC_mc20_delete_all',number_of_files_SLAC_mc20_delete_all)
